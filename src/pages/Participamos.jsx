...
import ilustracion from '../assets/ilus-participar.svg'
            ...
            <div className="cont cont-home">
                <div>
                    ...
                    <div className='cont-participar'>
                        <div className='cont-left-participar'>
                            <h2 className="titles title-participar">Quienes participamos</h2>
                            <p className='text-body text-body-participar'>En nuestra organización, los jóvenes tienen un rol preponderante en la toma de decisiones, en el armado de proyectos y en el desarrollo y posicionamiento de la Fundación en la región. Por ello, nuestro equipo está compuesto en su mayoría por hombres y mujeres menores de 30 años.
                            <span className='paragraph'>A dicho staff, ubicado en la sede en la ciudad de La Plata (Argentina),  se suman los 34 delegados que la Fundación posee a lo largo y ancho del globo.</span>
                            <span className='paragraph'>La presencia de estos representantes en cada ciudad del mundo nació de experiencias, pasantías y voluntariados que los mismos realizaron en nuestra institución cuando residieron en Argentina.</span>
                            </p>
                            <div className='cont-flex'>
                                <p className='text-body pre-btn'>En nuestra página los podés conocer </p>
                                <a href='https://fphv.org/' className='button-participar texto-btn'>¡Hacé click aquí!</a>
                            </div>
                        </div>
                        <div className='cont-right-participar'>
                            <img src={ilustracion} />
                            <Link to='/quienes-participamos' className='arrow'>
